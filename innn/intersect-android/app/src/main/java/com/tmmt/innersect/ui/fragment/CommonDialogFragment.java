...
public class CommonDialogFragment extends DialogFragment implements OnClickListener {
    ...
    public static CommonDialogFragment newInstance(int layoutId, String title) {
    ...
    public static CommonDialogFragment newInstance(int layoutId, String title,String content) {
        Bundle args = new Bundle();
        CommonDialogFragment fragment = new CommonDialogFragment();
        args.putInt("layoutId", layoutId);
    ...
    public static CommonDialogFragment newInstance(int layoutId, String title,String content,String cancel,String ok) {
        Bundle args = new Bundle();
        CommonDialogFragment fragment = new CommonDialogFragment();
        args.putInt("layoutId", layoutId);
